...
- 🛒 [**Amazon Clone**](https://github.com/tib-dev/amazon-clone)  
  *A full-stack e-commerce platform using React, Node.js, and Stripe integration.*

- 🎓 [**Education Management System**](https://ems-qsofti.netlify.app)  
  *A dynamic system to manage students, teachers, classes, and payments.*

- 🤖 [**LinkedIn Automation Tool**](https://github.com/tib-dev/linkedin-automation)  
  *Automates posts, comments, and interactions using Puppeteer and Node.js.*

> 💡 More projects on [my portfolio website](https://tibebukaleb.netlify.app)
